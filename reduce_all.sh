...
while [ $count3 -le 995 ]
do
  ./main ./systems/b15_C.sys systems/b15_C.wcnf ./systems/b15_C.syspp ./iscas85/b15_C.obs $count3 >> resducedb15_C.wcnf
/home/dell/下载/RC2/rc_solver/lib/python2.7/site-packages/pysat/examples/rc2.py -c b remain_clauses.wcnf >> run_result15_1.wcnf
/home/dell/下载/RC2/rc_solver/lib/python2.7/site-packages/pysat/examples/rc2.py -c b remain_clauses1.wcnf >> run_result15_2.wcnf
/home/dell/下载/RC2/rc_solver/lib/python2.7/site-packages/pysat/examples/rc2.py -c b remain_clauses2.wcnf >> run_result15_3.wcnf
  count3=$((count3+1))  
done
count3=1
while [ $count3 -le 1000 ]
do
  ./main ./systems/b17_C.sys systems/b17_C.wcnf ./systems/b17_C.syspp ./iscas85/b17_C.obs $count3 >> resducedb17_C.wcnf
/home/dell/下载/RC2/rc_solver/lib/python2.7/site-packages/pysat/examples/rc2.py -c b remain_clauses.wcnf >> run_result17_1.wcnf
/home/dell/下载/RC2/rc_solver/lib/python2.7/site-packages/pysat/examples/rc2.py -c b remain_clauses1.wcnf >> run_result17_2.wcnf
/home/dell/下载/RC2/rc_solver/lib/python2.7/site-packages/pysat/examples/rc2.py -c b remain_clauses2.wcnf >> run_result17_3.wcnf
  count3=$((count3+1)) 
done
count3=1
while [ $count3 -le 999 ]
